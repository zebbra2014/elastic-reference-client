...
public final class Genesis {
    ...
    public static final long GENESIS_BLOCK_ID = (new BigInteger("14803703721173236570")).longValue();
    ...
    public static final byte[] CREATOR_PUBLIC_KEY = { (byte)0xf5, (byte)0x22, (byte)0x3c, (byte)0xd5, (byte)0xc1, (byte)0xb6, (byte)0xff, (byte)0xa2, (byte)0x2a, (byte)0x38, (byte)0xa0, (byte)0xb6, (byte)0x83, (byte)0x59, (byte)0x13, (byte)0x2a, (byte)0x12, (byte)0x20, (byte)0x44, (byte)0xda, (byte)0x80, (byte)0x0b, (byte)0xc0, (byte)0xe0, (byte)0x55, (byte)0x89, (byte)0x15, (byte)0xa6, (byte)0x7d, (byte)0x6d, (byte)0xc0, (byte)0x02    };

    // Here, all the Genesis Coin Receipients are listed
    public static final long[] GENESIS_RECIPIENTS = {
            (new BigInteger("4273301882745002507")).longValue()};
    ...
    public static final byte[][] GENESIS_SIGNATURES = {
    	{-37 ,-71 ,114 ,16 ,-4 ,95 ,-61 ,28 ,89 ,113 ,-6 ,47 ,2 ,28 ,116 ,-71 ,-101 ,20 ,6 ,-103 ,7 ,-53 ,35 ,115 ,51 ,47 ,-26 ,25 ,-41 ,100 ,72 ,4 ,-88 ,-33 ,-125 ,-42 ,115 ,83 ,3 ,54 ,48 ,-15 ,-52 ,-21 ,73 ,-126 ,-110 ,33 ,104 ,3 ,126 ,22 ,58 ,121 ,-35 ,101 ,-25 ,62 ,116 ,-26 ,-17 ,-89 ,88 ,-112}
    };

    
    // And the block itself must be signed
    public static final byte[] GENESIS_BLOCK_SIGNATURE = new byte[]{
    	-95 ,87 ,-91 ,-59 ,114 ,107 ,27 ,-41 ,-72 ,-7 ,-54 ,-33 ,-21 ,-36 ,66 ,-78 ,-24 ,-75 ,-71 ,69 ,-114 ,-59 ,2 ,-87 ,43 ,-66 ,61 ,19 ,-41 ,111 ,54 ,4 ,86 ,115 ,106 ,-4 ,-1 ,-70 ,-110 ,-59 ,35 ,-42 ,54 ,70 ,56 ,53 ,-55 ,7 ,11 ,125 ,41 ,59 ,94 ,49 ,-67 ,12 ,-126 ,83 ,-115 ,-1 ,23 ,-76 ,-47 ,-44};
	    ...
	    try {
	        ...
	        for (int i = 0; i < Genesis.GENESIS_RECIPIENTS.length; i++) {
	            ...
	            for (int s=0; s<transaction.getSignature().length; ++s){
	            	signatures += String.valueOf((int)transaction.getSignature()[s]);
	        ...
	        BlockImpl genesisBlock = new BlockImpl(-1, 0, 0, Constants.MAX_BALANCE_NQT, 0, transactions.size() * 128, digest.digest(),
	                Genesis.CREATOR_PUBLIC_KEY, new byte[64], null, null, transactions);
	        ...
	        for (int s=0; s<genesisBlock.getBlockSignature().length; ++s){
            	signatures += String.valueOf((int)genesisBlock.getBlockSignature()[s]);
            	if (s<genesisBlock.getBlockSignature().length-1){
            		signatures += " ,";
            	}
            }signatures+="}\n";
	        Logger.logMessage("Genesisblock will have ID: " + genesisBlock.getStringId());
