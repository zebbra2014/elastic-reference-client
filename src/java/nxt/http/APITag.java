...
public enum APITag {
    ...
    TRANSACTIONS("Transactions"), VS("Voting System"), WC("Work Control"), POX("Proof-of-X"), SEARCH("Search"), UTILS("Utils"), DEBUG("Debug"), CANCEL_TRANSACTION("Cancel Transaction"), BOUNTY("Bounty"), POW("Pow"), TOKENS("Tokens");
