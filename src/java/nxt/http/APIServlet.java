...
public final class APIServlet extends HttpServlet {
    ...
    static {
        ...
        map.put("getAccountWork", GetAccountWork.instance);
        map.put("getAccountWorkEfficiencyPlot", GetAccountWorkEfficiencyPlot.instance);
        ...
        map.put("cancelWork", CancelWork.instance);
